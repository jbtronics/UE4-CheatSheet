...
\usepackage[left=0.5cm,right=0.5cm,top=0.5cm,bottom=2cm]{geometry}
...
\begin{multicols*}{2}
	...
	\begin{center}
		...
		\linebreak
		\Large{(C) J. Böhmer, \linebreak Licensed under CC BY-NC-SA 4.0}
		\linebreak
		\Large{Version 1.0}
	\end{center}
	...
	\begin{tabularx}{\columnwidth}{|l|X|}
		...
		&  ndicates that this property can be edited via property windows, archetypes and instances within the Editor \\ 
